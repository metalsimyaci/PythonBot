...
def geturls():
    url="http://mabushimajo.com/sitemap.xml"
...
def not_mabushimajo(href):
    return not (not href or re.compile("http://mabushimajo").search(href) or re.compile("#").search(href) or re.compile(
        ...
        "https://www.facebook.com/MabushiMajo").search(href) or re.compile("http://igemooneobi.blogspot.com.tr/").search(href) or re.compile(
        ...
        "https://www.reddit.com").search(href) or re.compile("http://uptobox.com").search(href) or re.compile("blogspot.com").search(href) or re.compile(
        "http://www.mediafire.com").search(href) or re.compile("http://www.mangapanda.com").search(href) or re.compile("http://Mabushimajo").search(href) or re.compile(
        "https://youtu.be").search(href) or re.compile("http://yok").search(href) or re.compile("http://www.webtoons.com").search(href) or re.compile(
